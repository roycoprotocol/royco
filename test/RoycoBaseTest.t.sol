...
contract RoycoBaseTest is Test {
    ...
    function testPostLPAsk() public { 
      ...
      (LPOrder order, uint256 orderId) = book.createLPOrder(depositToken, 100 ether, 10 days, desiredIncentives, allowedMarkets);
      ...
      depositToken.mint(address(this), 100 ether);
      depositToken.approve(address(book), 100 ether);
      ( , uint256 orderId2) = book.createLPOrder(depositToken, 100 ether, 10 days, desiredIncentives, allowedMarkets);

      assertEq(orderId + 1, orderId2);

      vm.expectRevert("TRANSFER_FROM_FAILED");
      book.createLPOrder(depositToken, 100 ether, 10 days, desiredIncentives, allowedMarkets);
    }
    ...
    function testPostIPAsk() public { 
      ...
      rewardToken.mint(address(this), 100 ether);
      rewardToken.approve(address(book), 100 ether);
      uint256 IPOrderId2 = book.createIPOrder(10 days, 100 ether, 1 ether, uint128(marketId));

      assertEq(IPOrderId + 1, IPOrderId2);
      
      vm.expectRevert("TRANSFER_FROM_FAILED");
      book.createIPOrder(10 days, 100 ether, 1 ether, uint128(marketId));
    }
    ...
    function createSimpleMarket() public returns (uint256 marketId) {
      // bytes32[] literal
      bytes32[] memory enterCommands = new bytes32[](2);
      enterCommands[0] = 0x095ea7b3010001ffffffffff32b62298fdd99c2be9d59dc93f5efd6cf5c2edb3;
      enterCommands[1] = 0x39dc5ef201020304ffffffff3cea719b30456e2f6877c2d449c91f7b15a9436b;
      ...
      marketId = book.createMarket(depositToken, rewardToken, Orderbook.MarketType.FL_Vesting, enter, exit);
    }
    ...
    function testCreateIPOrderAndFill() public {
      ...
      book.createIPOrderAndFill(10 days, 100 ether, 1 ether, uint128(marketId), orderId);
