...
struct Order {
    ...
    uint256 price;
    uint256 quantity;
    // uint256 fillAmount; // partial fills must be possible, can decide if "fillamounts" should be handled in a separate mapping vs in the order struct vs separate variable
    // ...
}
